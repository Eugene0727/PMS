...
if(isset($_POST['submit']))
  {
    $categoryId = get_category_lastId();
    $catname=$_POST['catename'];
    $id = $_GET['id'];

    $sql = mysqli_query($con, "select categoryId from tblcategory where VehicleCat='$catname' AND areaId='$id'");
    $num=mysqli_num_rows($sql);

    if($num == 0){
        $query=mysqli_query($con, "insert into  tblcategory values('$categoryId','$catname','$id')");
        if ($query) {
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="add-category.php?id=<?php $id = $_SESSION['id']; echo $id?>">Category</a></li>
