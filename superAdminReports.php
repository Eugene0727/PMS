...
$id = $_GET['id'];
$superAdId = $_SESSION['adminId'];
$adminId = $_SESSION['id'];
error_reporting(0);
if (strlen($_SESSION['vpmsaid']==0)) {
  header('location:logout.php');
  } else{
    $_SESSION['superadminfromdate'] = $_POST['fromdate'];
    $_SESSION['superadmintodate'] =$_POST['todate'];
    if(isset($_POST['submit'])){
        if($id == 'admin'){
            echo "<script>window.location.href ='bwdates-reports-details.php?id=$adminId'</script>";
        }
        else{
             echo "<script>window.location.href ='superAdminReportDetails.php?id=$superAdId'</script>";
        }
    }
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li><a href="superAdminReports.php?id=superadmin">Reports</a></li>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                <form method="post" enctype="multipart/form-data" class="form-horizontal" name="bwdatesreport">
