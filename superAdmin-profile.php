...
if (strlen($_SESSION['vpmsaid']==0)) {
    ...
    if(isset($_POST['submit']))
  {
    ...
    $email=$_POST['emailAdd'];
     ...
     $query=mysqli_query($con, "update tbladmin set UserName='$userName',Email='$email',MobileNumber='$contact' where ID='$id'");
    if ($query) {
  ...
  else
    {
     ...
     echo("<script>window.location.href ='superAdmin-profile.php?id=$id'</script>");
  }
  ?>
<!doctype html>
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Super Admin Profile</li>
                                </ol>
                            </div>
                        </div>
                    </div>
...
?>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class=" form-control" id="adminname" name="adminname" type="text" value="<?php  echo $row['AdminName'];?>"  readonly='true'></div>
                                    </div>
                                     <div class="row form-group">
                                     ...
                                     <div class="row form-group">
                                        ...
                                        <div class="col-12 col-md-9"><input class=" form-control" id="contactNo" name="contactNo" type="text" value="<?php  echo $row['MobileNumber'];?>"></div>
                                    </div>
                                     <div class="row form-group">
